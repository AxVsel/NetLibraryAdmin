...
namespace NetLibraryAdmin.model
{
    class general
    {
        public DataTable login(string username, string password)
        {
            var result = db.get_data("select id_pegawai, nama_lengkap, jabatan from tb_pegawai where id_pegawai='" + username + "' and passwd='" + password + "' and aktif='y'");
            return result;
        }
