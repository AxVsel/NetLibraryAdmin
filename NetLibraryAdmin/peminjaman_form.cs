...
namespace NetLibraryAdmin
{
    public partial class peminjaman_form : Form
    {
        ...
        private void panel_pinjam_Paint(object sender, PaintEventArgs e)
        {

        }

        private void peminjaman_form_Load(object sender, EventArgs e)
        {
        ...
        private void btn_cetak_pinjam_Click(object sender, EventArgs e)
        {
            ...
            //cetak laporan
            cetak laporan = new cetak();
            laporan.crystalReportViewer1.ReportSource = rd;
            laporan.ShowDialog();
        }
    }
    }
